...
package com.intuilab.intuifaceplayer.usbserial.driver;
...
public class UsbSerialProber {
    ...
    private UsbSerialProber(ProbeTable probeTable) {
        mProbeTable = probeTable;
    }

    public static UsbSerialProber getProber(final JSONObject opts) throws Exception {
